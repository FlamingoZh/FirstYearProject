...
from src.cropdataset import CropDataset
...
def newfunc():
    ...
    train_dataset = CropDataset(
        'OIDv4_ToolKit-master/OID/Dataset/cropped',
        pil_blur=False,
    )
    ...
    cc = torch.load('swav_800ep_pretrain.pth.tar', map_location="cpu")
    model_state_dict = {}
    for key in cc:
    ...
    pickle.dump(embedding_list,open("embedding_crop.pkl","wb"))
...
def newfunc2():
    ...
    for it, inputs in enumerate(train_loader):
        ...
        print(embedding.size())
        embedding_list.append(embedding.detach().numpy())
    pickle.dump(embedding_list,open("embedding_crop_vrd.pkl","wb"))
...
def newfunc3():
    ...
    for it, inputs in enumerate(train_loader):
        ...
        print(embedding.size())
        embedding_list.append(embedding.detach().numpy())
    pickle.dump(embedding_list,open("embedding_crop_predicate_vrd.pkl","wb"))
...
def get_image_embedding(image_path):
    ...
    #pickle.dump(embedding_list,open(dump_name,"wb"))
